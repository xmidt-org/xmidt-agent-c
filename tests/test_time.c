...
void test_metrics()
{
    struct test_clock rt[7] = {
        { .s = 10, .ns = 0, .rv = 0, .more = 1 },
        { .s = 10, .ns = 0, .rv = 0, .more = 1 },
        { .s = 20, .ns = 0, .rv = 0, .more = 1 },
        { .s = 1577836900, .ns = 0, .rv = 0, .more = 1 },
        { .s = 1577836901, .ns = 0, .rv = 0, .more = 1 },
        { .s = 0, .ns = 0, .rv = -1, .more = 1 },
        { .s = 0, .ns = 0, .rv = -1, .more = 0 },
    };
    struct test_clock mono[7] = {
        /* Things are bad - no clock */
        { .s = 80, .ns = 0, .rv = -1, .more = 1 },
        { .s = 100, .ns = 0, .rv = 0, .more = 1 },
        /* go backwards to simulate threading issues */
        { .s = 90, .ns = 0, .rv = 0, .more = 1 },
        { .s = 110, .ns = 0, .rv = 0, .more = 1 },
        { .s = 111, .ns = 0, .rv = 0, .more = 1 },
        { .s = 112, .ns = 0, .rv = 0, .more = 1 },
        { .s = 0, .ns = 0, .rv = -1, .more = 0 },
    };
    struct time_metrics m;
    ...
    CU_ASSERT(0 == m.invalid_count_after_valid);
    ...
    CU_ASSERT(1 == m.invalid_count_after_valid);
}
...
void add_suites(CU_pSuite *suite)
{
    *suite = CU_add_suite("utils.c tests", NULL, NULL);
    ...
    CU_add_test(*suite, "metrics Tests", test_metrics);
}
